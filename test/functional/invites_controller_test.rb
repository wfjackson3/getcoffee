...
class InvitesControllerTest < ActionController::TestCase
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post :create, invite: { event_id: @invite.event_id, position_id: @invite.position_id, status: @invite.status }
    end
  ...
  test "should update invite" do
    put :update, id: @invite, invite: { event_id: @invite.event_id, position_id: @invite.position_id, status: @invite.status }
    assert_redirected_to invite_path(assigns(:invite))
  end
